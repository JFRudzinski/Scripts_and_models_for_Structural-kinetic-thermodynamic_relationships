...
K3res[0,1] = geom_avg(k5,k2,w_opt,1.) # ( w_opt*k5 + k2 ) / (w_opt+1.)
K3res[0,2] = geom_avg(k5,k2,w_opt,1.) # ( w_opt*k5 + k2 ) / (w_opt+1.)
K3res[0,3] = k5
K3res[1,0] = geom_avg(k6,k1,v_opt,1.) # ( v_opt*k6 + k1 ) / (v_opt+1.)
K3res[2,0] = geom_avg(k6,k1,v_opt,1.) # ( v_opt*k6 + k1 ) / (v_opt+1.)
K3res[3,0] = k6
# helix nucleation: s7 [1 1 1] -> s4 [1 0 1], s5 [1 1 0], s6 [0 1 1] OR s5 [1 1 0], s6 [0 1 1] -> s3 [0 1 0]
K3res[7,4] = k3
K3res[7,5] = geom_avg(k1,k3,v_opt,1.) # ( v_opt*k1 + k3 ) / (v_opt+1.)
K3res[7,6] = geom_avg(k1,k3,v_opt,1.) # ( v_opt*k1 + k3 ) / (v_opt+1.)
K3res[6,3] = geom_avg(k1,k4,v_opt,1.) # ( v_opt*k1 + k4 ) / (v_opt+1.)
K3res[5,3] = geom_avg(k1,k4,v_opt,1.) # ( v_opt*k1 + k4 ) / (v_opt+1.)
K3res[4,7] = k4
K3res[5,7] = k2
K3res[6,7] = k2
K3res[3,6] = k2
...
K3res[4,2] = geom_avg(k6,k1,v_opt,1.) # ( v_opt*k6 + k1 ) / (v_opt+1.)
K3res[6,2] = k1
K3res[4,1] = geom_avg(k6,k1,v_opt,1.) # ( v_opt*k6 + k1 ) / (v_opt+1.)
K3res[5,1] = k1
K3res[2,4] = geom_avg(k6,k2,w_opt,1.) # ( w_opt*k6 + k2 ) / (w_opt+1.)
K3res[2,6] = k2
K3res[1,4] = geom_avg(k6,k2,w_opt,1.) # ( w_opt*k6 + k2 ) / (w_opt+1.)
K3res[1,5] = k2
